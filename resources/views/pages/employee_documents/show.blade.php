...
<div class="container-fluid py-4">
    <div class="row mb-4 align-items-center">
        <div class="col-md-6">
            <a href="{{ route('employee-documents.index') }}" class="btn btn-sm btn-outline-secondary rounded-pill px-3">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-5">
            ...
            <div class="card border-0 shadow-sm rounded-4">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('employee-documents.store', $employee->id) }}" enctype="multipart/form-data" id="uploadForm">
                        @csrf
                        <div class="row g-3">
                            <div class="col-12">
                                        ...
                                        <td class="text-end pe-3">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right shadow-sm border-0">
                                                    ...
                                                    <form method="POST" action="{{ route('employee-documents.approve', $doc->id) }}">
                                                        @csrf
                                            ...
                                            <div class="modal fade" id="rejectModal{{ $doc->id }}" tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content border-0 shadow rounded-4">
                                                        <form method="POST" action="{{ route('employee-documents.reject', $doc->id) }}">
                                                            @csrf
