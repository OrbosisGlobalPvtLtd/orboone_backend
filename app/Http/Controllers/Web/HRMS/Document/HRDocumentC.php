...
class HRDocumentC extends Controller
{
    public function index()
    {
        ...
        return view('hrms.document.hr.documents-all', compact('employees', 'types', 'accesses'));
    }
    ...
    public function show(User $user)
    {
        ...
        return view('hrms.document.employee.hr-documents', compact('user', 'documents', 'types', 'accesses', 'documentColumns'));
    }
