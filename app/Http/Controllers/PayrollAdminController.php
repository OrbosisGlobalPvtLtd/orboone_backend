...
class PayrollAdminController extends Controller
{
      public function structuresIndex()
    {
        ...
        return view('pages.payroll.index', compact('structures', 'accesses'))->with('active', 'payroll_index');
    }

    public function structuresCreate()
    {
        $accesses = \App\Models\Access::where('role_id', auth()->user()->role_id)->get();
        return view('pages.payroll.create', compact('accesses'))->with('active', 'payroll_index');
    }
    ...
    public function structuresEdit($id)
    {
        ...
        $accesses = \App\Models\Access::where('role_id', auth()->user()->role_id)->get();
        return view('pages.payroll.edit', compact('structure', 'accesses'))->with('active', 'payroll_index');
    }
    ...
    public function structuresAssignForm()
    {
        ...
        $accesses = \App\Models\Access::where('role_id', auth()->user()->role_id)->get();
        return view('pages.payroll.index', compact('employees', 'structures', 'accesses'));
    }
    ...
    public function dashboard()
    {
        ...
        return view('pages.payroll.dashboard', compact('employeesCount', 'totalSalaries', 'recentPayrolls', 'employees', 'accesses'));
    }
    ...
    public function salaryStructure()
    {
        ...
        return view('pages.payroll.salary_structure', [
            'employee' => $employee,
...
{
    $accesses = \App\Models\Access::where('role_id', auth()->user()->role_id)->get();
    return view('pages.payroll.payrollrun', compact('accesses'))->with('active', 'payroll_run');
}
...
public function payrollPreview($monthInput)
{
    ...
    return view('pages.payroll.preview', compact('payrolls', 'monthInput', 'accesses'))->with('active', 'payroll_run');
}
...
public function monthlyList()
{
    ...
    return view('pages.payroll.monthly_list', compact('payrolls', 'accesses'))->with('active', 'my_monthly_salary');
}
...
public function monthlyDetail($monthInput)
{
    ...
    return view('pages.payroll.monthly_detail', compact('payroll', 'monthInput', 'accesses'))->with('active', 'my_monthly_salary');
}
public function payslipsByMonth($monthInput)
{
    ...
    return view('pages.payroll.payslipindex', compact('payrolls', 'monthInput', 'accesses'))->with('active', 'payroll_run');
}
...
public function downloadAllPayslips($monthInput)
{
    ...
    public function payslips()
    {
        ...
        return view('pages.payroll.payslips', compact('payslips', 'accesses'))->with('active', 'my_payslips');
    }
...
public function salarySlipForm()
    {
        $employees = Employee::where('is_active', true)->orderBy('name')->get();
        $accesses = \App\Models\Access::where('role_id', auth()->user()->role_id)->get();
        return view('pages.payroll.salary_slip_form', compact('employees', 'accesses'))->with('active', 'payroll_run');
    }
...
public function statutorySettingsForm()
{
    ...
    return view('pages.payroll.statutorysettings', compact('settings'));
}
...
{
    return view('pages.payroll.statutoryreport_form');
}
...
public function statutoryReportView(Request $request)
{
    ...
    return view('pages.payroll.statutoryreport_view', compact('payrolls', 'monthInput', 'pt_total'));
}
...
public function deductions()
{
    ...
    return view('pages.payroll.deductions', compact('payrolls'));
}
public function fnfPendingEmployees()
{
    $employees = Employee::whereDoesntHave('fnf')->get();

    return view('pages.payroll.fnfpending', compact('employees'));
}
...
public function fnfCalculateForm(Employee $employee)
{
    ...
    return view('pages.payroll.fnfcalculate', compact('employee'));
}
...
public function fnfView()
{
    ...
    return view('pages.payroll.fnf', compact('fnf'));
}
...
public function claimsIndex()
{
    ...
    return view('pages.payroll.claims.index', compact('claims'));
}

public function claimsCreate()
{
    return view('pages.payroll.claims.create');
}
