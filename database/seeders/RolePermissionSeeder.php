    ...
    public function run(): void
    {
        ...
        */
        ...
        $rolePermissionKeys = [
            ...
            'admin' => [
                'dashboard.view',
                'employees.view','employees.create','employees.edit','employees.delete','employees.pending_profiles.view','employees.pending_profiles.approve','employees.probation_internship.view','employees.probation_internship.manage','employees.exit.view','employees.exit.manage','employees.organization.manage','employees.reporting_structure.manage','departments.manage','designations.manage',
                'attendance.dashboard.view','attendance.records.view_all','attendance.monthly_report.view_all','attendance.monthly_summary.view','attendance.export','attendance.work_reports.view_all',
