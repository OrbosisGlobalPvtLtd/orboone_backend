...
class EnterpriseSalaryStructureSyncS
{
     ...
     */
    public function syncFromEmployee($employee, ?string $reason = null, bool $throwOnFailure = false): void
    {
        ...
        try {
            ...
            if ($activeStructure) {
                ...
                if (
                    Carbon::parse($activeStructure->effective_from, 'Asia/Kolkata')->toDateString() === $effectiveDate
                ...
                if (Carbon::parse($activeStructure->effective_from, 'Asia/Kolkata')->toDateString() === $effectiveDate) {
