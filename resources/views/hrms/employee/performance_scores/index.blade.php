    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12 text-center text-lg-right">
                ...
                @endif
                <a href="{{ route('hrms.employees.performance_scores.export') }}" class="btn btn-outline-light ml-2 rounded-pill px-4 py-2 font-weight-bold" target="_blank" style="border-width: 2px;">
...
<div class="container-fluid px-2 px-md-4 py-4" style="position: relative; z-index: 10;">
    <div class="filter-section mt-2 shadow-lg">
        <form action="{{ route('hrms.employees.performance_scores.index') }}" method="GET" class="row align-items-end">
                    ...
                    <tr>
                        ...
                        <td data-label="Actions" class="text-md-right action-col">
                            <div class="d-flex justify-content-end">
                                ...
                                <form action="{{ route('hrms.employees.performance_scores.destroy', ['employeeScore' => $score->group_id]) }}" method="POST" class="d-inline m-0">
                                    @csrf
                                    @method('DELETE')
