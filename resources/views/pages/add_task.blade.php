...
@php
    ...
    $action = $isEdit ? route('pages.update_task', $task->id) : route('pages.add_task');
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="mb-4 d-flex justify-content-between align-items-center">
                    <a href="{{ route('task_management') }}" class="btn btn-back">
                    ...
                    <div class="card-body p-5">
                        <form action="{{ $action }}" method="POST" id="taskForm">
                            ...
                            @if($isEdit)
                                ...
                                {{-- Note: Route::post('/update_task/{id}', [TaskmanagementController::class, 'update'])->name('pages.update_task'); --}}
                            @endif
