...
use App\Models\CRM\ClientModel;
class ClientController extends Controller
{
    public function client_data()
    {
        $client_data = ClientModel::all();
        return view('crm.client_data', compact('client_data'));
    }

    public function showForm()
    {
        return view('crm.client_add');
    }
    ...
    {
        $client_data = ClientModel::all();
        return view('crm.client_data_print', compact('client_data'));
    }
}