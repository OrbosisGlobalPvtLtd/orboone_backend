    ...
    <div class="row mb-4 align-items-center">
        ...
        <div class="col-lg-6 text-lg-right mt-3 mt-lg-0">
            @if (collect($accesses)->where('menu_id', 11)->first()->status == 10)
                <a href="{{ route('departments-data.create') }}" class="btn btn-orb mr-2">
                    <i class="fas fa-plus-circle mr-2"></i> New Department
                </a>
            @endif
            <a href="{{ route('departments-data.print') }}" class="btn btn-light shadow-sm" style="border-radius: 50px;" target="_blank">
    ...
    <div class="card custom-card">
        <div class="card-header bg-white border-0 py-4 px-4">
            <div class="row align-items-center">
                <div class="col-md-4">
                    <form action="{{ route('departments-data') }}" method="GET">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="pl-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="{{ route('departments-data.show', $department->id) }}" class="font-weight-bold text-dark h6 mb-0">
                                        {{ $department->name }}
                                    </a>
                                </div>
                            </td>
                            ...
                            <td class="text-right pr-4">
                                <a href="{{ route('departments-data.edit', $department->id) }}" class="action-btn" title="Edit Settings">
                                    <i class="fas fa-cog"></i>
                                </a>
                                <a href="{{ route('departments-data.show', $department->id) }}" class="action-btn ml-1" title="View Details">
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-5">
                                ...
                                <a href="{{ route('departments-data.create') }}" class="btn btn-sm btn-orb">Add First Department</a>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
