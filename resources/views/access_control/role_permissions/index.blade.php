    ...
    <div class="ac-container">
        ...
        <div class="ac-header">
            <div>
                ...
                <p class="ac-subtitle">Allocate module-level authorization scopes and capabilities to role profiles.</p>
            </div>
        </div>
        ...
        <div class="ac-card">
            <div class="ac-table-header">
                <div class="ac-table-head-left">
                    ...
                    <div>
                        <h5 class="ac-table-title">Role Mapping Registers</h5>
                        <p class="ac-table-subtitle">Select a target role to map permissions and validate authorization gates.</p>
                    </div>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-right">
                                        <a href="{{ route('role_permissions.edit', $role->id) }}" class="ac-btn ac-btn-soft text-primary" style="border-color: rgba(75, 0, 232, 0.15) !important; background: var(--ac-soft) !important;">
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center text-muted py-5">
                                    <div style="font-size: 24px; color: var(--ac-muted);"><i class="fas fa-lock"></i></div>
                                    <h6 class="mt-3 font-weight-bold">No Roles Found</h6>
                                    <p class="small mb-0">Create role templates first before allocating permissions.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
