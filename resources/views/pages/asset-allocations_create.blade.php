...
<div class="container-fluid py-4 px-4">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-lg-6">
            <h3 class="font-weight-bold text-dark mb-1">Assign Asset</h3>
            <p class="text-muted m-0">Allocate a new asset to an employee</p>
        </div>
        <div class="col-lg-6 text-lg-right mt-3 mt-lg-0">
            <a href="{{ route('asset-allocations.index') }}" class="btn btn-light shadow-sm" style="border-radius: 50px;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="asset_type" id="asset_type" class="form-control @error('asset_type') is-invalid @enderror" onchange="toggleAssetFields()" required>
                                        ...
                                        <option value="Mobile" {{ old('asset_type') == 'Mobile' ? 'selected' : '' }}>Mobile</option>
                        ...
                        <div id="asset_fields" class="dynamic-section mb-4 p-4 bg-light rounded" style="display:none; border: 1px solid #e3e6f0;">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3" id="asset_brand_field">
                                    ...
                                    <input type="text" name="brand_model" id="brand_model" class="form-control" placeholder="e.g. Dell XPS 15">
                                </div>
                                <div class="col-md-4 mb-3" id="asset_sn_field">
                                    <label class="form-label">Asset ID / Serial No. <span class="text-danger">*</span></label>
                                    <input type="text" name="asset_id_sn" id="asset_id_sn" class="form-control" placeholder="e.g. SN-98765">
                                </div>
                                ...
                                <div class="col-md-6 mb-3" id="mobile_sim_field" style="display:none;">
                                    ...
                                    <input type="text" name="mobile_sim_number" id="mobile_sim_number" class="form-control" placeholder="+91 XXXXX XXXXX">
                                </div>
                                <div class="col-md-6 mb-3" id="plan_details_field" style="display:none;">
                                    <label class="form-label">Plan Details</label>
                                    <input type="text" name="plan_details" id="plan_details" class="form-control" placeholder="e.g. Corporate 5G Unlimited">
                                </div>
                                ...
                                <div class="col-md-12 mb-3" id="id_card_field" style="display:none;">
                                    ...
                                    <div class="d-flex gap-3 flex-wrap bg-white p-3 border rounded shadow-sm">
                                        <div class="form-check mr-4">
                                            <input class="form-check-input" type="checkbox" name="id_card_options[]" value="RFID Access" id="rfid_access">
                                            <label class="form-check-label font-weight-bold ml-1 cursor-pointer" for="rfid_access">RFID Access Room</label>
                                        </div>
                                        <div class="form-check mr-4">
                                            <input class="form-check-input" type="checkbox" name="id_card_options[]" value="Biometric" id="biometric">
                                            <label class="form-check-label font-weight-bold ml-1 cursor-pointer" for="biometric">Biometric Sync</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="id_card_options[]" value="Visual ID Only" id="visual_id">
                                ...
                                <div class="col-md-12 mb-3" id="accessories_field">
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="custom-control custom-switch mr-4">
                                            <input type="checkbox" class="custom-control-input" id="has_charger" name="has_charger" value="1">
                                            <label class="custom-control-label font-weight-bold" for="has_charger">Charger</label>
                                        </div>
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="has_bag" name="has_bag" value="1">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control" required>
                                        <option value="Active" {{ old('status') == 'Active' ? 'selected' : '' }}>Assigned (Active)</option>
