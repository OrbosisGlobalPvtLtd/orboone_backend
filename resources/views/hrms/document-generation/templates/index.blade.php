...
<style>
    ...
    .orb-stat-card.danger::after { background: #EC4E74; }
    ...
    .orb-stat-icon.danger { background: rgba(236,78,116,0.1); color: #EC4E74; }
...
<div class="orb-page-wrapper">
    ...
    <div class="orb-hero">
        <div>
            ...
            <p class="orb-hero-subtitle">Manage reusable HR letter and certificate templates.</p>
        </div>
        <div class="orb-hero-actions">
            ...
            @endif
            @if(Route::has('hrms.document-generation.dashboard'))
            <a href="{{ route('hrms.document-generation.dashboard') }}" class="orb-btn-light">
                <i class="fas fa-file-invoice"></i> Generate Document
            </a>
            @endif
            <button type="button" class="orb-btn-white" data-bs-toggle="modal" data-bs-target="#createTemplateModal">
    ...
    <div class="orb-stat-grid">
        ...
        <div class="orb-stat-card warning">
            <div class="orb-stat-icon warning"><i class="fas fa-certificate"></i></div>
            <div class="orb-stat-info">
                @php
                    $certCount = \App\Models\HRMS\DocumentGeneration\DocumentTemplate::where('is_certificate', true)->count();
                @endphp
                <h4>{{ $certCount }}</h4>
        ...
        <div class="orb-stat-card danger">
            ...
            <div class="orb-stat-info">
                @php
                    $reviewCount = \App\Models\HRMS\DocumentGeneration\DocumentTemplate::where('requires_review', true)->count();
                @endphp
                <h4>{{ $reviewCount }}</h4>
                <p>Review Required</p>
            </div>
    ...
    <div class="orb-table-card">
        <div class="orb-table-head">
            ...
            <div>
                <button type="button" class="orb-btn-white border" style="color:var(--orb-text);" data-bs-toggle="modal" data-bs-target="#createTemplateModal">
                    <i class="fas fa-plus text-primary"></i> New Template
                </button>
            </div>
        </div>
        ...
        <div class="orb-filter-row">
            ...
            <div class="orb-filter-group">
                ...
                <select id="dtCert" class="orb-filter-control">
            ...
            <table id="templatesTable" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $template->is_certificate ? 'Yes' : 'No' }}</td>
                        <td>{{ $template->requires_review ? 'Yes' : 'No' }}</td>
                        <td>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-2">
                                <button type="button" class="orb-action-btn" data-bs-toggle="modal" data-bs-target="#editTemplateModal{{ $template->id }}" title="Edit Template">
        ...
        <div class="modal-content orb-modal">
            <form method="POST" action="{{ route('hrms.document-generation.templates.store') }}">
                ...
                <div class="modal-body orb-modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="mb-4">
                                <textarea name="html_template" class="orb-form-control" rows="12" required placeholder="Enter HTML content here..."></textarea>
                            </div>
                ...
                <div class="modal-footer orb-modal-footer">
                    <button type="button" class="orb-btn-white border" style="color:var(--orb-text);" data-bs-dismiss="modal">Cancel</button>
                ...
                <div class="modal-body orb-modal-body">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <h6 class="orb-section-title">2. Template Content *</h6>
                            <div class="mb-4">
                                <textarea name="html_template" class="orb-form-control" rows="12" required>{{ $template->html_template }}</textarea>
                            </div>
