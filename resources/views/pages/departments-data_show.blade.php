...
<div class="container-fluid py-4 px-4">
    ...
    <div class="mb-4">
        <a href="{{ route('departments-data') }}" class="text-muted small font-weight-bold text-decoration-none">
            ...
            <div class="card custom-card">
                ...
                <div class="card-body p-5">
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        <a href="{{ route('departments-data.edit', $department->id) }}" class="btn btn-orb-edit mr-3 shadow-sm">
                            <i class="fas fa-edit mr-2"></i> Modify Department
                        </a>
                        
                        <form action="{{ route('departments-data.destroy', $department->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
