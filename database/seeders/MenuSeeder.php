...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $menus = [
            ...
            ['id' => 145, 'name' => 'My Attendance', 'route' => 'hrms.attendance.my', 'icon' => 'fas fa-user-clock', 'module_key' => 'attendance', 'parent_id' => 20, 'sort_order' => 3],
            ...
            ['id' => 26, 'name' => 'Monthly Attendance Report', 'route' => 'attendances.monthly-report', 'icon' => 'fas fa-calendar-alt', 'module_key' => 'attendance', 'parent_id' => 20, 'sort_order' => 7],
            ['id' => 134, 'name' => 'Monthly Attendance Summary', 'route' => 'hrms.attendance.monthly_summary.index', 'icon' => 'fas fa-table', 'module_key' => 'attendance', 'parent_id' => 20, 'sort_order' => 8],
            ['id' => 135, 'name' => 'Attendance Violations', 'route' => 'hrms.attendance.violations.index', 'icon' => 'fas fa-exclamation-triangle', 'module_key' => 'attendance', 'parent_id' => 20, 'sort_order' => 9],
            ['id' => 24, 'name' => 'Shift & Attendance Rules', 'route' => 'attendance.rules.index', 'icon' => 'fas fa-business-time', 'module_key' => 'attendance', 'parent_id' => 20, 'sort_order' => 10],
            ['id' => 25, 'name' => 'Attendance Status Types', 'route' => 'attendance.types.index', 'icon' => 'fas fa-tags', 'module_key' => 'attendance', 'parent_id' => 20, 'sort_order' => 11],
            ['id' => 136, 'name' => 'Attendance Policy Overrides', 'route' => 'hrms.attendance.policy_overrides.index', 'icon' => 'fas fa-sliders-h', 'module_key' => 'attendance', 'parent_id' => 20, 'sort_order' => 12],
            ['id' => 27, 'name' => 'Export Attendance Report', 'route' => 'attendances.export-pdf', 'icon' => 'fas fa-file-pdf', 'module_key' => 'attendance', 'parent_id' => 20, 'sort_order' => 13],
            ...
            ['id' => 32, 'name' => 'My Leave Requests', 'route' => 'leave-requests.index', 'icon' => 'fas fa-paper-plane', 'module_key' => 'leave', 'parent_id' => 30, 'sort_order' => 2],
            ['id' => 137, 'name' => 'Apply Leave', 'route' => 'leave-requests.create', 'icon' => 'fas fa-plus-circle', 'module_key' => 'leave', 'parent_id' => 30, 'sort_order' => 3],
            ...
            ['id' => 34, 'name' => 'Leave Balance', 'route' => 'hrms.leave.balances.index', 'icon' => 'fas fa-wallet', 'module_key' => 'leave', 'parent_id' => 30, 'sort_order' => 6],
            ...
            ['id' => 43, 'name' => 'My Salary Slips', 'route' => 'pages.payroll.payslips', 'icon' => 'fas fa-file-invoice-dollar', 'module_key' => 'payroll', 'parent_id' => 40, 'sort_order' => 5],
