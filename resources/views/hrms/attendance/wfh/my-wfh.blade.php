    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
        <form method="POST" action="{{ route('hrms.attendance.my-wfh.apply') }}" class="modal-content ep-form border-0 shadow-lg">
            ...
            <div class="ep-modal-header">
                ...
                <p>Submit a WFH request for manager and HR approval.</p>
            ...
            <div class="ep-modal-body">
                <div class="ep-section-card mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2"><small class="text-muted d-block">Source</small><strong id="d_source">-</strong></div>
    ...
    (function() {
        document.querySelectorAll('.js-view-details').forEach(function(btn) {
            btn.addEventListener('click', function() {
                ...
                document.getElementById('d_source').textContent = fmt(row.source_label);
