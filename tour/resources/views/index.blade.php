            ...
            <div class="container">
                ...
                <div class="row ">
                    <div class="col-xl-4 col-lg-4 offset-md-1 col-md-4 col-sm-12 col-12 mb40">
                        <div class="tour-img">
                            <a href="/international_tour" class="imghover"> <img src="https://tour.orbosis.in/public/imagess/tour_img_1.jpg" alt="" class="img-fluid"></a>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 offset-md-1 col-md-4 col-sm-12 col-12 mb40">
                        <div class="tour-img">
                            <a href="/domestic_tour" class="imghover"> <img src="https://tour.orbosis.in/public/imagess/tour_img_2.jpg" alt="" class="img-fluid"></a>
                        </div>
                    </div>
                </div>
                <!-- /.tour-2 -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 nopr">
                        <div class="service-block border-bottom border-right">
                            <div class="service-img"><img src="https://tour.orbosis.in/public/imagess/hotel_1.png" alt=""></div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 nopl nopr">
                        <div class="service-block border-bottom border-right">
                            <div class="service-img"><img src="https://tour.orbosis.in/public/imagess/disability.png" alt=""></div>
                            <div class="service-content">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 nopl">
                        <div class="service-block border-bottom">
                            <div class="service-img"><img src="https://tour.orbosis.in/public/imagess/airplane.png" alt=""></div>
                            <div class="service-content">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 nopr">
                        <div class="service-block border-right">
                            <div class="service-img"><img src="https://tour.orbosis.in/public/imagess/passport.png" alt=""></div>
                            <div class="service-content">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 nopl nopr">
                        <div class="service-block  border-right">
                            <div class="service-img"><img src="https://tour.orbosis.in/public/imagess/car_wash.png" alt=""></div>
                            <div class="service-content">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 nopl">
                        <div class="service-block service-right-border service-bottom-border">
                            <div class="service-img"><img src="https://tour.orbosis.in/public/imagess/car.png" alt=""></div>
                            <div class="service-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6">
                        <div class="client-logo">
                            <a href="#"><img src="https://tour.orbosis.in/public/imagess/dummy_logo_1.png" alt=""></a>
                        </div>
                    </div>
                    <!-- /.client-logo -->
                    <!-- client-logo -->
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6">
                        <div class="client-logo">
                            <a href="#"> <img src="https://tour.orbosis.in/public/imagess/dummy_logo_2.png" alt=""></a>
                        </div>
                    </div>
                    <!-- /.client-logo -->
                    <!-- client-logo -->
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6">
                        <div class="client-logo">
                            <a href="#">  <img src="https://tour.orbosis.in/public/imagess/dummy_logo_3.png" alt=""></a>
                        </div>
                    </div>
                    <!-- /.client-logo -->
                    <!-- client-logo -->
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6">
                        <div class="client-logo">
                            <a href="#"><img src="https://tour.orbosis.in/public/imagess/dummy_logo_4.png" alt=""></a>
                        </div>
                    </div>
                    <!-- /.client-logo -->
                    <!-- client-logo -->
