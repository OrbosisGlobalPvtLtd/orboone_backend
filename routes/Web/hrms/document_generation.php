...
Route::middleware(['auth'])->group(function () {
    Route::prefix('hrms/document-generation')->name('hrms.document-generation.')->group(function () {
        ...
        Route::prefix('templates')->name('templates.')->group(function () {
            ...
            Route::post('/{id}/detect-fields', [DocumentTemplateC::class, 'detectFields'])->name('detect-fields')->middleware('permission:document_generation.template_edit');
            Route::get('/{id}/download-original', [DocumentTemplateC::class, 'downloadOriginal'])->name('download-original')->middleware('permission:document_generation.download');
        ...
        Route::prefix('generated')->name('generated.')->group(function () {
            ...
            Route::get('/{id}/download-docx', [GeneratedDocumentC::class, 'downloadDocx'])->name('download-docx')->middleware('permission:document_generation.download');
