...
<head>
    ...
    <title>Verify OTP | {{ $branding['company_name'] ?? config('app.name', 'OrboOne HRMS') }}</title>
...
<body>
    <div class="auth-card">
        ...
        <form action="{{ route('password.otp.verify') }}" method="POST">
            ...
            <input type="text" name="otp" inputmode="numeric" maxlength="6" value="{{ old('otp') }}" placeholder="Enter 6-digit OTP" required style="letter-spacing: 4px; text-align: center; font-size: 18px; font-weight: 700;">
