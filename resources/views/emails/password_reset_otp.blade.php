...
<body style="margin:0;padding:0;background:#f4f6f9;font-family:Arial,Helvetica,sans-serif;color:#111827;">
    <div
        ...
        <div style="padding:22px;background:#4B00E8;color:#ffffff;text-align:center;">
            <h1 style="margin:0;font-size:22px;">OrboOne HRMS</h1>
        </div>
        <div style="padding:26px;">
            ...
            <p style="margin:18px 0 0;color:#6b7280;font-size:13px;">For your security, never share this OTP with anyone. If you did not request this, please ignore this email.</p>
        </div>
    </div>
</body>
