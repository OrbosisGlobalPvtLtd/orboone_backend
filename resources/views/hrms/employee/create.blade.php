                    ...
                    <div class="eo-card-body">
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 eo-field">
                                ...
                                <input type="date" name="salary_effective_from" class="form-control"
                                    value="{{ old('salary_effective_from') }}">
                            </div>

                            <div class="col-xl-3 col-lg-4 col-md-6 eo-field">
                                <label>Salary Reason</label>
                                <input type="text" name="salary_change_reason" class="form-control"
                                    value="{{ old('salary_change_reason') }}" placeholder="Initial salary">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateProbation() {
                ...
                const date = new Date(joiningDate.value + 'T00:00:00');
