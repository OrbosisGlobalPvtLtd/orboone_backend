                        ...
                        @forelse($payrolls as $p)
                            <tr>
                                <td class="px-4">
                                    ...
                                    <small class="text-muted">ID: {{ $p->employee->id }}</small>
                                </td>
                                <td class="text-center">
                                    <span class="badge badge-light border">{{ $p->paid_days ?? '-' }} / {{ $p->working_days ?? '-' }}</span>
                                </td>
                                <td class="text-right">₹{{ number_format($p->basic, 2) }}</td>
                                <td class="text-right">₹{{ number_format($p->gross_salary, 2) }}</td>
                                <td class="text-right text-danger">-₹{{ number_format($p->total_deductions, 2) }}</td>
                                <td class="text-right">
