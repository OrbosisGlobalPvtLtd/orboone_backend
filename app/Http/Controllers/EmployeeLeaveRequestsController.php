...
class EmployeeLeaveRequestsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.employees-leave-request', compact('employeeLeaveRequests', 'accesses'))->with('active', 'leave-approval');
    }
    ...
    public function summary()
    {
        ...
        return view('pages.employees-leave-summary', compact('employees', 'accesses', 'holidays'))->with('active', 'leave-summary');
    }
    ...
    public function create()
    {
        ...
        return view('pages.employees-leave-request_create', compact('employee', 'employeeLeaves', 'accesses'))->with('active', 'leave-request');
    }
