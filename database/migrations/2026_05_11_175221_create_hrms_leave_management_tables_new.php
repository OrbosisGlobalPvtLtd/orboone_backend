    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('leave_types')) {
            ...
            Schema::table('leave_types', function (Blueprint $table) {
                ...
                if (!Schema::hasColumn('leave_types', 'is_paid')) {
                    $table->boolean('is_paid')->default(false)->after('code');
                }
                if (!Schema::hasColumn('leave_types', 'is_sick')) {
                    $table->boolean('is_sick')->default(false)->after('is_paid');
                }
                if (!Schema::hasColumn('leave_types', 'is_lwp')) {
                    $table->boolean('is_lwp')->default(false)->after('is_sick');
                }
                if (!Schema::hasColumn('leave_types', 'is_comp_off')) {
                    $table->boolean('is_comp_off')->default(false)->after('is_lwp');
                }
                if (!Schema::hasColumn('leave_types', 'requires_attachment')) {
                    $table->boolean('requires_attachment')->default(false)->after('is_comp_off');
                }
                if (!Schema::hasColumn('leave_types', 'medical_certificate_after_days')) {
                    $table->unsignedTinyInteger('medical_certificate_after_days')->nullable()->after('requires_attachment');
                }
                if (!Schema::hasColumn('leave_types', 'max_days_per_month')) {
                    $table->decimal('max_days_per_month', 6, 2)->nullable()->after('medical_certificate_after_days');
                }
                if (!Schema::hasColumn('leave_types', 'max_days_per_request')) {
                    $table->decimal('max_days_per_request', 6, 2)->nullable()->after('max_days_per_month');
                }
                if (!Schema::hasColumn('leave_types', 'allow_half_day')) {
                    $table->boolean('allow_half_day')->default(true)->after('max_days_per_request');
                }
                if (!Schema::hasColumn('leave_types', 'applicable_after_confirmation')) {
                    $table->boolean('applicable_after_confirmation')->default(false)->after('allow_half_day');
                }
                if (!Schema::hasColumn('leave_types', 'color')) {
                    $table->string('color', 30)->nullable()->after('applicable_after_confirmation');
                }
        ...
        if (!Schema::hasTable('leave_requests')) {
            ...
            Schema::table('leave_requests', function (Blueprint $table) {
                ...
                if (!Schema::hasColumn('leave_requests', 'requested_days')) {
                    $table->decimal('requested_days', 8, 2)->default(0);
                }
                if (!Schema::hasColumn('leave_requests', 'deducted_days')) {
                    $table->decimal('deducted_days', 8, 2)->default(0);
                }
                if (!Schema::hasColumn('leave_requests', 'is_half_day')) {
                    $table->boolean('is_half_day')->default(false);
                }
                if (!Schema::hasColumn('leave_requests', 'half_day_type')) {
                    $table->string('half_day_type')->nullable();
                }
                if (!Schema::hasColumn('leave_requests', 'attachment_path')) {
                    $table->string('attachment_path')->nullable();
                }
                if (!Schema::hasColumn('leave_requests', 'approved_by_user_id')) {
                    $table->unsignedBigInteger('approved_by_user_id')->nullable();
                }
                ...
                if (!Schema::hasColumn('leave_requests', 'sandwich_applied')) {
                    $table->boolean('sandwich_applied')->default(false);
                }
                if (!Schema::hasColumn('leave_requests', 'paid_days')) {
                    $table->decimal('paid_days', 8, 2)->default(0);
                }
                if (!Schema::hasColumn('leave_requests', 'sick_days')) {
                    $table->decimal('sick_days', 8, 2)->default(0);
                }
                if (!Schema::hasColumn('leave_requests', 'comp_off_days')) {
                    $table->decimal('comp_off_days', 8, 2)->default(0);
                }
        ...
        if (DB::table('weekoff_rules')->count() === 0) {
