...
<body>
    ...
    <table>
        ...
        <tr><td>HRA</td><td class="right">{{ number_format((float) $payroll->hra, 2) }}</td><td>TDS</td><td class="right">{{ number_format((float) $payroll->tds, 2) }}</td></tr>
        <tr><td>Special Allowance</td><td class="right">{{ number_format((float) $payroll->special_allowance, 2) }}</td><td>Attendance Deduction</td><td class="right">{{ number_format((float) $payroll->attendance_deduction, 2) }}</td></tr>
        <tr><td>Bonus</td><td class="right">{{ number_format((float) $payroll->bonus_amount, 2) }}</td><td>LWP Deduction</td><td class="right">{{ number_format((float) $payroll->lwp_deduction, 2) }}</td></tr>
        <tr><td>Incentive</td><td class="right">{{ number_format((float) $payroll->incentive_amount, 2) }}</td><td>Half-Day Deduction</td><td class="right">{{ number_format((float) $payroll->half_day_deduction, 2) }}</td></tr>
        <tr><td>Reimbursement</td><td class="right">{{ number_format((float) $payroll->reimbursement_amount, 2) }}</td><td>Absent Deduction</td><td class="right">{{ number_format((float) $payroll->absent_deduction, 2) }}</td></tr>
