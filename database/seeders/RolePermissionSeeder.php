    ...
    public function run(): void
    {
        ...
        $rolePermissionKeys = [
            ...
            'hr_admin' => [
                'dashboard.view',
                // Employee Management
                'employees.view','employees.create','employees.edit','employees.delete','employees.update','employees.directory.view','employees.performance.view','employees.pending_profiles.view','employees.pending_profiles.approve','employees.probation_internship.view','employees.probation_internship.manage','employees.exit.view','employees.exit.manage','employees.organization.manage','employees.reporting_structure.manage','departments.manage','designations.manage','organization_hierarchy.manage','employee.shift.assign.manage','probation.manage',
