...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $menus = [
            ...
            ['id' => 164, 'name' => 'Attendance Policies', 'route' => 'attendance.policies.index', 'icon' => 'fas fa-shield-alt', 'module_key' => 'attendance', 'parent_id' => 20, 'sort_order' => 11],
            ['id' => 24, 'name' => 'Shift Timings', 'route' => 'attendance.rules.index', 'icon' => 'fas fa-clock', 'module_key' => 'attendance', 'parent_id' => 20, 'sort_order' => 12],
            ['id' => 351, 'name' => 'Access Control', 'route' => 'attendances.access-control', 'icon' => 'fas fa-user-lock', 'module_key' => 'attendance', 'parent_id' => 20, 'sort_order' => 13],
            ['id' => 25, 'name' => 'Attendance Status Types', 'route' => 'attendance.types.index', 'icon' => 'fas fa-tags', 'module_key' => 'attendance', 'parent_id' => 20, 'sort_order' => 14],
            ['id' => 136, 'name' => 'Attendance Policy Overrides', 'route' => 'hrms.attendance.policy_overrides.index', 'icon' => 'fas fa-sliders-h', 'module_key' => 'attendance', 'parent_id' => 20, 'sort_order' => 15],
            ['id' => 27, 'name' => 'Export Attendance Report', 'route' => 'attendances.export-pdf', 'icon' => 'fas fa-file-pdf', 'module_key' => 'attendance', 'parent_id' => 20, 'sort_order' => 16],
            ...
            ['id' => 36, 'name' => 'Leave History', 'route' => 'hrms.leave.history', 'icon' => 'fas fa-history', 'module_key' => 'leave', 'parent_id' => 30, 'sort_order' => 5],
            ['id' => 146, 'name' => 'Team Leave Calendar', 'route' => 'hrms.leave.team_calendar.index', 'icon' => 'fas fa-calendar-week', 'module_key' => 'leave', 'parent_id' => 30, 'sort_order' => 6],
