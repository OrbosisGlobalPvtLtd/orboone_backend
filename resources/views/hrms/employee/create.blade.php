    ...
    <div class="eo-container">
        ...
        <div class="eo-header">
            <div>
                ...
                <p class="eo-subtitle">Create employee account, role, department and salary details.</p>
            </div>
        ...
        <form action="{{ route('employees-data.store') }}" method="POST">
            @csrf
                ...
                <div class="eo-card-body">
                    <div class="row">
                        <div class="col-xl-3 col-lg-4 col-md-6 eo-field">
                            ...
                            <input type="text" class="form-control readonly-field" value="{{ $nextEmployeeCode }}" readonly>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 eo-field">
                            ...
                            <input type="email" name="email" class="form-control" value="{{ old('email') }}" placeholder="employee@company.com" required>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 eo-field">
                            ...
                            <select name="reporting_manager_employee_id" class="form-select">
                                ...
                                @foreach($reportingManagers as $manager)
                                    <option value="{{ $manager->id }}" {{ old('reporting_manager_employee_id') == $manager->id ? 'selected' : '' }}>
                    ...
                    <div id="intern_box" class="eo-intern-panel">
                        <div class="row">
                            <div class="col-xl-3 col-lg-4 col-md-6 eo-field">
                                ...
                                <input type="date" name="internship_start_date" id="internship_start_date" class="form-control" value="{{ old('internship_start_date') }}">
                            </div>

                            <div class="col-xl-3 col-lg-4 col-md-6 eo-field">
                                <label>Internship End Date <span class="required">*</span></label>
                                <input type="date" name="internship_end_date" id="internship_end_date" class="form-control" value="{{ old('internship_end_date') }}">
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 eo-field">
                                ...
                                <select name="is_paid_intern" id="is_paid_intern" class="form-select">
                                    ...
                                    <option value="1" {{ old('is_paid_intern') === '1' ? 'selected' : '' }}>Paid</option>
                                    <option value="0" {{ old('is_paid_intern') === '0' ? 'selected' : '' }}>Unpaid</option>
                                </select>
                            </div>
                ...
                <div class="eo-card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 eo-field">
                            ...
                            <input type="number" name="actual_salary" id="actual_salary" class="form-control" value="{{ old('actual_salary') }}" min="0" step="1" placeholder="Enter salary">
                        </div>
                    </div>
                </div>
            </div>
