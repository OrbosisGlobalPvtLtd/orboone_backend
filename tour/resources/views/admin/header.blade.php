        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-show" id="remove_class" onclick="show()" data-toggle="dropdown"
                        href="#">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('admin/dist/img/1.jpg') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item ">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/admin/add-package" class="nav-link ">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add New Package</p>
                                    </a>
                                </li>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/admin/view-package" class="nav-link ">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View/Manage Package</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="/admin/view-booking" class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    View Bookings
                                    <!-- <i class="right fas fa-angle-left"></i> -->
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="/admin/all-trip" class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>
                                    Running & Closed Trips
                                    <!-- <i class="right fas fa-angle-left"></i> -->
                                </p>
                            </a>
                        </li>
