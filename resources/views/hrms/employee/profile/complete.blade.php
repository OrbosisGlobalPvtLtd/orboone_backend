...
@section('page_title', 'Complete Employee Profile')
...
<div class="profile-page">
    <div class="profile-container">
        ...
        <div class="profile-header">
            <div>
                <h1 class="profile-title">Complete Employee Profile</h1>
        ...
        <form action="{{ route('hrms.employees.profile.store', $employeeData->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="profile-card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 profile-field">
                            ...
                            <textarea name="address" class="form-control" placeholder="Enter full address" required>{{ old('address', $employeeData->address) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-6 profile-field">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('highest_qualification', $employeeData->highest_qualification) }}"
                                   class="form-control"
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 profile-field">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('cgpa_percentage', $employeeData->cgpa_percentage) }}"
                                   class="form-control"
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 profile-field">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('total_experience', $employeeData->total_experience) }}"
                                   class="form-control"
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-6 profile-field">
                            ...
                            <input name="bank_holder_name"
                                   value="{{ old('bank_holder_name', $employeeData->bank_holder_name) }}"
                                   class="form-control"
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 profile-field">
                            ...
                            <input name="bank_account_no"
                                   value="{{ old('bank_account_no', $employeeData->bank_account_no) }}"
                                   class="form-control"
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 profile-field">
                            ...
                            <input name="ifsc_code"
                                   value="{{ old('ifsc_code', $employeeData->ifsc_code) }}"
                                   class="form-control"
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 profile-field">
                            ...
                            <input name="bank_branch"
                                   value="{{ old('bank_branch', $employeeData->bank_branch) }}"
                                   class="form-control"
            ...
            <div class="profile-actions-bar">
                <div class="profile-actions-note">
                    Save profile details to complete employee onboarding.
                </div>
