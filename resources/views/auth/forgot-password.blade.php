...
<head>
    ...
    <style>
        ...
        input{width:100%;height:44px;border-radius:12px;border:1px solid #E7EAF3;background:#F9FAFB;padding:8px 12px;font-size:14px;box-sizing:border-box;}
        button,.auth-link{width:100%;min-height:44px;border:0;border-radius:12px;margin-top:14px;display:flex;align-items:center;justify-content:center;gap:8px;text-decoration:none;font-weight:800;}
        button{background:linear-gradient(135deg, var(--orb-primary), var(--orb-secondary));color:#fff;cursor:pointer;}
        .auth-link{color:var(--orb-primary);background:#F4F2FF;}
