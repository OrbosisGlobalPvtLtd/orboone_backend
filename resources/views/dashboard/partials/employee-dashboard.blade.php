...
const statusThemes = {
    'Progress': { bg: '#eff6ff', color: '#2563eb', border: '2px solid #3b82f6' },
    'Testing':  { bg: '#f3e8ff', color: '#7c3aed', border: '2px solid #8b5cf6' },
    'Done':     { bg: '#dcfce7', color: '#15803d', border: '2px solid #22c55e' },
    'Blocked':  { bg: '#fee2e2', color: '#b91c1c', border: '2px solid #ef4444' }
};
...
function selectStatusPill(status) {
    ...
    document.querySelectorAll('.status-pill-btn').forEach(btn => {
        ...
        if (s === status) {
            const theme = statusThemes[s] || { bg: '#f3e8ff', color: '#7c3aed', border: '2px solid #7c3aed' };
