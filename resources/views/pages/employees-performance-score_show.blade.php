...
<style>
    ...
    .info-card:hover { box-shadow: 0 15px 35px rgba(0,0,0,0.08); }

    .profile-section {
        border-bottom: 2px dashed #edf2f9;
        padding-bottom: 30px;
        margin-bottom: 30px;
    }
    ...
    .stat-value { font-weight: 700; color: #2c3e50; font-size: 0.9rem; }
    ...
    .score-item:hover { border-color: #4b00e8; transform: translateY(-2px); }
    ...
    .progress-bar { border-radius: 7px; background: var(--orbosis-gradient); }
    ...
    .overall-badge {
        ...
        margin: 0 auto 20px;
        box-shadow: 0 10px 25px rgba(75, 0, 232, 0.3);
    ...
    @media (max-width: 768px) {
        ...
        .overall-badge { width: 100px; height: 100px; font-size: 2rem; }
    }
</style>
        ...
        <div class="col-lg-8 mb-4">
            <div class="info-card">
                ...
                <div class="text-right mt-5 pt-4 border-top">
                    ...
                    <a href="{{ route('employees-performance-score.edit', ['employeeScore' => $employeeScore->group_id]) }}" class="btn btn-warning btn-action mr-2 mb-2 mb-md-0 shadow-sm font-weight-bold text-dark">
                        <i class="fas fa-edit mr-2"></i> Edit Record
                    </a>
                    <form action="{{ route('employees-performance-score.destroy', ['employeeScore' => $employeeScore->group_id]) }}" method="POST" class="d-inline mb-2 mb-md-0 m-0">
                        @csrf
                        @method('DELETE')
                    ...
                    @endif
                    <a href="{{ route('employees-performance-score.print') }}" class="btn btn-dark btn-action shadow-sm font-weight-bold" target="_blank">
