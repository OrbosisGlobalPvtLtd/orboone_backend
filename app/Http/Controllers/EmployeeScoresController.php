...
class EmployeeScoresController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.employees-performance-score', compact('employeeScores', 'accesses'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.employees-performance-score_create', compact('employees', 'scoreCategories', 'accesses'));
    }
    ...
    public function show(Request $request, $group_id)
    {
        ...
        return view('pages.employees-performance-score_show', compact('employeeScore', 'scores', 'accesses'));
    }
    ...
    public function edit($group_id)
    {
        ...
        return view('pages.employees-performance-score_edit', compact('employees', 'scoreCategories', 'scores', 'employeeScore', 'accesses'));
    }
