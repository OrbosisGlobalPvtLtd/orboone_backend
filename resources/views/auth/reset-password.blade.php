...
<head>
    ...
    <title>Reset Password | {{ $branding['company_name'] ?? config('app.name', 'OrboOne HRMS') }}</title>
...
<body>
    <div class="auth-card">
        ...
        <form action="{{ route('password.reset.update') }}" method="POST">
            ...
            <input type="password" name="password_confirmation" placeholder="Re-type new password" required>
