...
<div class="container-fluid admin-dashboard-shell">
        ...
        <div class="row align-items-center">
            <div class="col-lg-8 hero-content">
                ...
                <p class="mb-0 text-white-50" style="font-size: 1rem;">
                    Here is your premium Orbosis HRMS admin dashboard summary for today.
                </p>
                ...
                <div class="hero-kpis">
                    ...
                    <div class="hero-mini-card">
                        ...
                        <div class="value" style="font-size:1rem;">{{ auth()->user()->primaryRole->name ?? 'Admin' }}</div>
                    </div>
                    <div class="hero-mini-card">
