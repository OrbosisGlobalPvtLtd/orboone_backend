@extends('layouts.panel', ['active' => 'technical_lead_dashboard'])

@section('page_title', 'Technical Supervision Dashboard')
...
<div class="tl-page">
    <div class="tl-container">
        ...
        <div class="tl-hero">
            <div>
                <h1><i class="fas fa-laptop-code mr-2"></i>Technical Supervision Dashboard</h1>
                <p class="mb-0 opacity-90">Cross-project technical guidance, developer monitoring, and daily status oversight.</p>
            </div>
            <div>
                <a href="{{ route('technical_lead.developers') }}" class="btn btn-light font-weight-bold px-4 py-2" style="border-radius: 12px; color: var(--orb-primary);">
                    <i class="fas fa-user-plus mr-2"></i>Assign Developers
                </a>
            </div>
        </div>

        <!-- Comprehensive Metric KPI Cards Row 1 -->
        <div class="row mb-3">
            <div class="col-6 col-md-4 col-lg-2 mb-3">
                <div class="tl-metric-card">
                    <div class="tl-metric-icon"><i class="fas fa-users-cog"></i></div>
                    <div>
                        <div class="text-muted small font-weight-bold text-uppercase" style="font-size: 10px;">Total Developers</div>
                        <div class="h4 font-weight-extrabold mb-0 text-dark">{{ $developersCount }}</div>
                    </div>
                </div>
            </div>
            <div class="col-6 col-md-4 col-lg-2 mb-3">
                <div class="tl-metric-card">
                    <div class="tl-metric-icon" style="background: rgba(245, 158, 11, 0.1); color: #F59E0B;"><i class="fas fa-project-diagram"></i></div>
                    <div>
                        <div class="text-muted small font-weight-bold text-uppercase" style="font-size: 10px;">Active Projects</div>
                        <div class="h4 font-weight-extrabold mb-0 text-dark">{{ $projectsCount }}</div>
                    </div>
                </div>
            </div>
            <div class="col-6 col-md-4 col-lg-2 mb-3">
                <div class="tl-metric-card">
                    <div class="tl-metric-icon" style="background: rgba(16, 185, 129, 0.1); color: #10B981;"><i class="fas fa-user-check"></i></div>
                    <div>
            ...
            <div class="col-6 col-md-4 col-lg-2 mb-3">
                <div class="tl-metric-card">
                    <div class="tl-metric-icon" style="background: rgba(59, 130, 246, 0.1); color: #3B82F6;"><i class="fas fa-home"></i></div>
                    <div>
            ...
            <div class="col-6 col-md-4 col-lg-2 mb-3">
                <div class="tl-metric-card">
                    <div class="tl-metric-icon" style="background: rgba(239, 68, 68, 0.1); color: #EF4444;"><i class="fas fa-user-times"></i></div>
                    <div>
            ...
            <div class="col-6 col-md-4 col-lg-2 mb-3">
                <div class="tl-metric-card">
                    <div class="tl-metric-icon" style="background: rgba(168, 85, 247, 0.1); color: #A855F7;"><i class="fas fa-file-invoice"></i></div>
                    <div>
                        <div class="text-muted small font-weight-bold text-uppercase" style="font-size: 10px;">Work Reports Submitted</div>
        ...
        <!-- Main Content Grid -->
        <div class="row">
            <!-- Today's Developer Status Table -->
            <div class="col-lg-8">
                <div class="tl-section-card">
                    <div class="tl-section-header">
                        <h5 class="tl-section-title"><i class="fas fa-user-clock mr-2 text-primary"></i>Today's Developer Daily Status</h5>
                        <a href="{{ route('technical_lead.developers') }}" class="small font-weight-bold" style="color: var(--orb-primary);">View All Developers &rarr;</a>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="py-3 px-4 align-middle">
                                        ...
                                        <small class="text-muted">{{ $item['employee']->employee_code }} &bull; {{ optional($item['employee']->designation)->name ?? 'Developer' }}</small>
                                    </td>
                                    <td class="py-3 align-middle">
                                        @if(!empty($item['projects']) && count($item['projects']) > 0)
                                            @foreach($item['projects'] as $prj)
                                                <div class="mb-1">
                                                    <span class="badge badge-light border text-primary font-weight-bold px-2 py-0.5" style="border-radius: 6px;">{{ $prj->project_name }}</span>
                                                    @if($prj->team_name)
                                                        <small class="text-muted d-block">&bull; {{ $prj->team_name }}</small>
                                                    @endif
                                                </div>
                                            @endforeach
                                        @else
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-5">No developers assigned under Technical Lead supervision yet. Click "Assign Developers" above to begin.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
            ...
            <!-- Supervised Tasks Summary Breakdown Card -->
            <div class="col-lg-4">
                <div class="tl-section-card">
                    <div class="tl-section-header">
                        <h5 class="tl-section-title"><i class="fas fa-tasks mr-2 text-primary"></i>Supervised Tasks Breakdown</h5>
                    </div>
                    <div class="p-4">
